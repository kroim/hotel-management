                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                                <ul class="nav nav-tabs nav-stacked text-center">
                                    ...
                                    <li class="active"><a href="{{ url('client/profile') }}"><span><i class="fa fa-user"></i></span>Profile</a></li>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-5 col-md-4 user-img">
                                                <img src="{{ asset('home_template/01/images/default/user-profile.jpg') }}" class="img-responsive" alt="user-img" />
                                            </div><!-- end columns -->
