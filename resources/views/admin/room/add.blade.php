            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div id="add-listing">
                        ...
                        <form action="{{ url('administrator/room/add') }}" method="post">
                            ...
                            <div class="add-listing-section">
                                ...
                                <div class="row with-forms">
                                    <div class="col-md-12">
                                        ...
                                        <input class="search-field" type="text" name="room_type_name" value="" required/>
                                    </div>
                                </div>
                                <!-- Row -->
                                <div class="row with-forms">
                            ...
                            <div class="add-listing-section margin-top-45">
                                ...
                                <div class="form">
                                    <h5>Description</h5>
                                    <textarea class="WYSIWYG" name="room_description" cols="40" rows="3" spellcheck="true"></textarea>
                                </div>
                                                ...
                                                <tr class="pricing-list-item pattern">
                                                    <td>
                                                        ...
                                                        <div class="fm-input pricing-price">
                                                            <input type="text" placeholder="Price" data-unit="USD" name="room_price" value="50" required/></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                            ...
                            <input type="submit" id="create_room" name="create_room_submit" style="display: none" value="Create Room">
                        </form>
                        <!-- Section -->
                        <div class="add-listing-section margin-top-45">
                        ...
                        <a href="#" class="button preview" onclick="create_room()">Create Room <i class="fa fa-arrow-circle-right"></i></a>
