                    ...
                    <div id="add-listing">
                        ...
                        <div class="add-listing-section">
                            ...
                            <div class="row with-forms">
                                <div class="col-md-12">
                                    @if($check_region_name==true)
                                        <h4 style="color: red;"> The Region Name is exist already</h4>
                                    @endif
                                    <form method="post" action="{{ url('/administrator/regions/add') }}">
                                        <input name="_token" value="{{ csrf_token() }}" style="display: none">
                                        <input class="form-control" type="text" name="region_name" placeholder="e.g China"
                                               value="{{ $origin_name }}" required/>
                                        <input type="submit" name="add_region_submit" value="Add Region">
                                    </form>
                                </div>
                            </div>
